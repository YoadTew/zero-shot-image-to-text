...
class CLIPTextGenerator:
    ...
    def init_args(self, args):
        ...
        self.reset_context_delta = args.reset_context_delta
        self.num_iterations = args.num_iterations
        self.clip_loss_temperature = args.clip_loss_temperature
        self.clip_scale = args.clip_scale
        self.ce_scale = args.ce_scale
        self.stepsize = args.stepsize
        self.grad_norm_factor = args.grad_norm_factor
        self.fusion_factor = args.fusion_factor
        self.repetition_penalty = args.repetition_penalty
        self.end_token = self.lm_tokenizer.encode(args.end_token)[0]
        self.end_factor = args.end_factor
        self.ef_idx = 1
        self.forbidden_factor = args.forbidden_factor
...
def run(args, img_path):
    text_generator = CLIPTextGenerator(args)
